  ...
  <section class="content">
    <div id="modal1" class="modal">
      <div class="modal-content">
        <h4>Yakin?</h4>
        <p>Apakah anda yakin ingin menghapus data ujian <b id="confirm"></b>?</p>
      </div>
    ...
    <div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">//Ujian </h1></div>
    <!-- Stat Boxes -->
      <div class="row">
        <div class="col s12">
          <div class="row">
            <div class="col s3">
              <a href="{{ url('/dashboard/ujian/add') }}"><button class="btn waves-effect waves-light">Tambah Ujian</button></a> 
            </div>
          </div>
...
@section("js")
  ...
  $('.datatable').DataTable({
      ...
      serverSide: true,
      order: [ [0, 'desc'] ],
      ajax: '{{ url('/dashboard/ujian/serverSide') }}'
  });
