  ...
  <section class="content">
    <div id="modal1" class="modal">
      <div class="modal-content">
        <h4>Yakin?</h4>
        <p>Apakah anda yaking ingin menghapus data dengan username <b id="confirm"></b> ?</p>
      </div>
    ...
    <!-- Stat Boxes -->
      <div class="row">
        <div class="col s12">
          <div class="row">
            <div class="col s3">
              <a href="{{ url('/dashboard/siswa/add') }}"><button class="btn waves-effect waves-light">Tambah Siswa</button></a>
            </div>
          </div>
...
@section("js")
  ...
  $('.datatable').DataTable({
      ...
      serverSide: true,
      order: [ [0, 'desc'] ],
      ajax: '{{ url('/dashboard/users/serverSide') }}'
  });
