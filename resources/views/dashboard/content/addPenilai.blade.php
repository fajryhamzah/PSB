...
@section("content")
  ...
  <section class="content">
    <div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">//Tambah Penilai </h1></div>
    <!-- Stat Boxes -->
    <div class="row">
     <form class="col s12" method="post">
       <div class="row">
         ...
         <div class="input-field col s8">
           ...
           <input id="icon_telep" type="email" name="email" class="validate">
